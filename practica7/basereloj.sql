...
PRIMARY KEY (ideq));
select * from Equipos;
ALTER TABLE HoraEquipos ADD FOREIGN KEY (idhsincr) REFERENCES HoraCentral(id) on update cascade;
ALTER TABLE HoraEquipos ADD FOREIGN KEY (idequipo) REFERENCES Equipos(ideq) on update cascade;
