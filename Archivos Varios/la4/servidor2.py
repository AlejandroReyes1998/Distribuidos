...
clientePrincipal = ("127.0.0.2",5015)
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                mySql_insert_query = "INSERT INTO info (ip, puerto, jugador, hora, resultado) VALUES ('{}','{}','{}','{}',{}) ".format(addr[0],addr[1],2,xd,suma)
            ...
            s.connect((HOSTS1, PORTS1))
            data = json.dumps({"ip": addr[0], "puerto": addr[1], "jugador": 2,"hora":xd,"resultado":suma})
            s.send(data.encode())
            s.close()

class send2server(Thread):
    def __init__(self,r1):
        Thread.__init__(self)
        self.r1=r1
        self.s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        ...
        while True:
            ...
            try:
                connection = mysql.connector.connect(host='localhost',
                                                    ...
                                                    user='root',
                                                    password='')
                mySql_insert_query = "INSERT INTO info (ip, puerto, jugador, hora, resultado) VALUES ('{}','{}','{}','{}',{}) ".format(theip,theport,theplayer,thehour,theresult)
