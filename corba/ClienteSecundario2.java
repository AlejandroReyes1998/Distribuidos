...
public class ClienteSecundario2 extends JFrame implements Runnable,ActionListener{
	JLabel reloj;
	Thread h1;
	Interfaz s;
	InetAddress gpo;
            ...
            while(true){
				...
				if(!msj.startsWith("HOLA")){
					if(msj.startsWith("pausa")){
                        ...
                        s.horas = (Integer.parseInt(hora[0])>1)?Integer.parseInt(hora[0])-1:23;
	...
	public static void main(String []args){
		ClienteSecundario2 c=new ClienteSecundario2();
